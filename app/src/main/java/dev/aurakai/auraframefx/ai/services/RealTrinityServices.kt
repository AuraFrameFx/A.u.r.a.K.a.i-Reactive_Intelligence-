...
class RealAuraAIService @Inject constructor(
    ...
    override fun analyticsQuery(_query: String): String = "Analytics placeholder"

    override suspend fun downloadFile(fileId: String): java.io.File? = null

    override suspend fun generateImage(prompt: String): ByteArray? = null

    override fun getAIResponse(prompt: String, options: Map<String, Any>?): String? = "AI Response Placeholder"

    override fun getMemory(memoryKey: String): String? = null

    override fun saveMemory(key: String, value: Any) {}

    override fun isConnected(): Boolean = true

    override fun publishPubSub(topic: String, _message: String) {}

    override fun getAppConfig(): dev.aurakai.auraframefx.ai.config.AIConfig? = null

    override suspend fun discernThemeIntent(query: String): String = "creative"

    override suspend fun suggestThemes(contextQuery: String): List<String> = listOf("modern", "cyberpunk")
