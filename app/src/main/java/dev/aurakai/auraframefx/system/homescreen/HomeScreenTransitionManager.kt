...
// import dev.aurakai.auraframefx.di.YukiHookModulePrefs
...
class HomeScreenTransitionManager @Inject constructor(
    ...
    // private val prefs: YukiHookModulePrefs, // Removed to fix KSP build error
    // private val overlayService: YukiHookServiceManager, // Removed to fix KSP build error
) {
